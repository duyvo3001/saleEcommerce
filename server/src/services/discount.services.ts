...
interface IDiscountCode extends Pick<DiscountCode, 'shopId'> { codeId: string }
interface IcancelDiscountCode extends Pick<DiscountCode, 'shopId' | 'userId'> { codeId: string }
