...
const connectString = `mongodb+srv://${config_mongodb_1.default.db.name}:${config_mongodb_1.default.db.pass}@${config_mongodb_1.default.db.host}.tzjnjep.mongodb.net/?retryWrites=true&w=majority`;
class Database {
    constructor() {
        this.connect();
    }
    connect() {
        mongoose_1.default.connect(connectString, { maxPoolSize: +process.env.MONGO_MAX_POOL_SIZE })
            .then(() => console.log('Connected to MongoDB Successfully :  '), check_connect_1.conuntConnect)
